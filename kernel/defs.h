...
void            kfree(void *);
void            kinit(void);
extern struct   frame_info  frames_table[MAX_FRAMES]; // frame table defined in kalloc.c
...
void            procdump(void);
uint64          kgetppid(void);
uint64          kgetnumchild(void);
uint64          kgetchildsyscount(void);
void            priority_boost(void);
uint64          kgetmlfqinfo(void);
uint64          kgetvmstats(void);
...
void            add_to_frame_table(uint64, struct proc*, uint64);
